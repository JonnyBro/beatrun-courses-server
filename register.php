	...
	<body>
		<section>
			...
			<?php if (!isset($_SESSION["steamid"])) { ?>
				...
				<p>Terms of use:<br>1) Don't share apikeys.<br>2) Don't post courses with names that are deemed offensive.<br>3) Don't spam the servers with garbage courses.<br>Failure to obide by these terms will result in API key termination.</p>
			<?php return; } ?>
			<!-- Login process end -->

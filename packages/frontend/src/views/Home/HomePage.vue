<template>
	<div class="text-center w-full">
		<div class="text-5xl font-bold font-mono mb-3">Jonny's Courses Database</div>
		<div class="text-lg font-mono mb-3">
			<RouterLink to="profile" class="underline">Authorize with Steam</RouterLink>
